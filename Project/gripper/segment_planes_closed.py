...
gt_ply = "gripper/2f85_closed_gt.ply"
...
# Segmentation for inner left link
...
plane = o3d.geometry.TriangleMesh.create_box(width=0.15, height=0.15, depth=0.001)
plane.translate([0-0.075, 0-0.075, 0.124294])
plane.paint_uniform_color([1, 0, 0])
planes.append(plane)

plane = o3d.geometry.TriangleMesh.create_box(width=0.15, height=0.001, depth=0.15)
plane.translate([0-0.075, -0.018674, 0.061981-0.075])
plane.paint_uniform_color([0, 1, 0])
planes.append(plane)

plane = o3d.geometry.TriangleMesh.create_box(width=0.15, height=0.001, depth=0.15)
plane.translate([0-0.075, -0.001385, 0.117759-0.075])
plane.paint_uniform_color([0, 1, 0])
planes.append(plane)

# Segmentation for inner right link
...
o3d.visualization.draw_geometries([gt_pcd]+planes)
