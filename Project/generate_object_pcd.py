...
pandaUid = p.loadURDF("/home/uas-laptop/Visual-Learning-Recognition/Project/pybullet-playground-20240518T073454Z-001/pybullet-playground/urdf/sisbot.urdf", [0, 0, 0],  p.getQuaternionFromEuler([0,0,0]), flags=flags, useFixedBase=False)
...
while True:
    ...
    o3d.io.write_point_cloud("cic_ur5_gt.ply", pcd)
